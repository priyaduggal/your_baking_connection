         ...
         <div class="content-column col-lg-8 col-md-12 col-sm-12">
            <div class="inner-column">
               <div class="content">
                  ...
                  <p>Your Baking Connection was thoughtfully created using smart and intuitive tools
                     for consumers to find custom, unique and delicious goods made with love. When
                     you’re looking for something special for all of life’s events, look no further than
                     your local community of talented home bakers.
                  </p>
                  <p>Your Baking Connection was founded by Ericka Johnson; wife, mom and lifelong
                     baker with a passion for helping others. After more than 20 years in corporate
                     America, and helping her then 13-year-old daughter launch her bakery business,
                     she wanted to do more to help other bakers. She started the blog, Your Baking
                     Bestie, with the goal of promoting the talents of home bakers and inspiring others
                     to follow their passions. It was through these experiences that she witnessed
                     bakers struggling to make a livable income, despite their incredible talents. Your
                     Baking Connection was her brainchild to create a marketplace for consumers to
                     connect with bakers, allowing them to spend more time doing what they love.
                  </p>
                  <p>Ericka is passionate about helping bakers realize their potential while creating
                     thriving businesses. Member bakers have access to state-of-the-art tools on Your
                     Baking Connection’s website and app to create their custom storefront, share a
                     gallery of work, sell goods, connect with customers and use proprietary analytics
      ...
      <div class="row">
         ...
         <div class="feature-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box">
               ...
               <!--h3>Tradition</h3-->
               <p>Connecting consumers with talented bakers in their communities to
                  purchase top quality and custom goods.
               </p>
            </div>
         </div>
         <!-- Feature Block -->
         <div class="feature-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box">
               ...
               <!--h3>Quality</h3-->
               <p>Supporting bakers in recognition of their talent, gifts and passion.</p>
            </div>
         </div>
         <!-- Feature Block -->
         <div class="feature-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box">
               ...
               <!--h3>Creatuvity</h3-->
               <p>Creating a thriving marketplace enabling bakers to be successful while
         ...
         <div class="feature-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box">
               ...
               <!--h3>Creatuvity</h3-->
               <p>Encouraging aspiring bakers to follow their dreams and to show success is
                  attainable.
               </p>
            </div>
         </div>
         ...
         <div class="testimonial-block">
            <div class="inner-box">
               <div class="testimonial_img">
                  <img src="<?php echo Yii::app()->theme->baseUrl?>/assets/images/user.jpg" class="img-fluid" alt="">
               </div>
