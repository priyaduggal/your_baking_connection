...
<div class="card boxsha"  v-cloak v-if="!loading">
     ...
     <h4 class="mb-2 mt-2 d-flex justify-content-between align-items-center">
                  View Order
                  <a href="<?php echo Yii::app()->createUrl('/orders/history')?>" class="btn btn-success addbtn">Back To Order</a>
                             ...
                             <div class="col-md-12 mb-3">
                                <div class="boxsha">
                                          <div class="card border-0 style-2">
                                                  ...
                                                  <div class="card-body fullbox">
                                                     <h2>Address</h2>
                                                    <p> {{order_info.delivery_address}}</p>
                                                   </div>
                                       </div>
                                                            ...
                                                            <li  v-for="(items, index) in items">
                                                               <div class="row align-items-center w-100">
                                                                  <div class="col-4 col-md-4 col-xl-4">
                                                                     <img class=" img-fluid" :src="items.url_image" >
                                                                  </div>
                                                                  ...
                                                                  <div class="col">
                                                                     <p class="mb-0">
                                                                        <a class="text-body">
                        												 {{items.qty}}x
                        											     {{ items.item_name }}
                        											   <span v-if=" items.price.size_name!='' "> 
                        											  ({{items.price.size_name}})
                        											  </span>  
                        											  </a> 
                        												<br>
                                                                        <span class="theme-cl" v-if="items.price.discount>0"><del>{{items.price.pretty_price}}</del> {{items.price.pretty_price_after_discount}}</span>
                                                                        <span class="theme-cl" v-else>{{items.price.pretty_price}}</span>
                                                                     </p>
	...
	<div class="boxsha">
	   <div class="card border-0 style-2">
		  ...
		  <div class="card-body">
			 ...
			 <template  v-for="summary in order_summary">
				<li class="list-group-item d-flex justify-content-between" v-if=" summary.type=='total' ">
