  ...
  <div class="col-md-8">
    <div class="boxsha posordercreate">
        <ul class="nav nav-pills customstyle-nav-tabs mt-2 mb-2 pt-3  px-3">
            <li class="active"><a data-toggle="pill" href="#home" class="active">Added Products</a></li>
            <li><a data-toggle="pill" href="#menu1">New Product</a></li>
        </ul>
               ...
               $random1=rand(100,999);
                ...
                <div class="row appendhtml appendhtml<?php echo $random1;?>" >
                        ...
                        foreach($all1 as $al=>$value){
                         $random=rand(100,999);
                        ?>
                        <div class="row appendrow<?php echo $random;?> m-0">
                            <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Price</label>
                              <div class="col-lg-12">
