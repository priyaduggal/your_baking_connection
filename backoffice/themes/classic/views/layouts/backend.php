...
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl?>/assets/css/admin.css"/>
...
<div class="container-fluid m-0 p-0">
 ...
 <div class="accountinfo contactus">
 <div class="main-container">
    <div class="main-container-wrap">
       <div class="container">
           <div class="profilebox pt-0 loginbox tabs-box">
       <?php echo $content;?>
       </div>
       </div> <!--container-->
